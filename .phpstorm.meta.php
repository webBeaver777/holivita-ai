...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\AI\AIClientInterface' => \App\Services\AI\AnythingLLMClient::class,
    ...
    override(\config(), map([
            ...
            'ai.anythingllm.api_url' => 'string',
            'ai.anythingllm.api_key' => 'string',
            'ai.anythingllm.workspace_slug' => 'string',
            'ai.anythingllm.summary_workspace_slug' => 'string',
            'ai.default_provider' => 'string',
            'ai.onboarding.welcome_prompt' => 'string',
            'ai.onboarding.queue' => 'string',
            'ai.onboarding.job_tries' => 'integer',
            'ai.onboarding.job_backoff' => 'integer',
            'ai.onboarding.session_expiry_hours' => 'integer',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links./home/webbeaver/Рабочий стол/work_repo/holivita-ai/public/storage' => 'string',
...
'ai.anythingllm.api_url','ai.anythingllm.api_key','ai.anythingllm.workspace_slug','ai.anythingllm.summary_workspace_slug','ai.default_provider',
'ai.onboarding.welcome_prompt','ai.onboarding.queue','ai.onboarding.job_tries','ai.onboarding.job_backoff','ai.onboarding.session_expiry_hours',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/webbeaver/Рабочий стол/work_repo/holivita-ai/public/storage','logging.default',
...
'sanctum.csrf-cookie','onboarding.validate-user','onboarding.chat','onboarding.async.chat','onboarding.async.status',
'onboarding.complete','onboarding.cancel','onboarding.history','summaries.index','summaries.show','home','onboarding','summaries','storage.local',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','ANYTHINGLLM_API_URL','ANYTHINGLLM_API_KEY',
'ANYTHINGLLM_WORKSPACE','ANYTHINGLLM_SUMMARY_WORKSPACE',);
