        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div v-if="!userId" class="bg-white rounded-2xl shadow-xl p-8 mt-8">
                ...
                <div class="text-center mb-8">
                    <div class="w-20 h-20 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
            ...
            <div v-else class="flex flex-col h-[calc(100vh-2rem)]">
                ...
                <div v-if="isCompleted" class="bg-white/70 px-4 py-3 flex-shrink-0">
                    <div class="flex items-center justify-center bg-green-50 text-green-600 rounded-xl px-4 py-2 text-sm border border-green-200">
                ...
                <div class="bg-white rounded-b-2xl shadow-lg p-3 flex-shrink-0">
                    <div class="flex items-end space-x-3">
                        <textarea
                            ...
                            :placeholder="isCompleted ? 'Знакомство завершено' : 'Напиши сообщение...'"
                            rows="1"
